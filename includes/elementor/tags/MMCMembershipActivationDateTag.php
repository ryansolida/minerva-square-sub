<?php
/**
 * MMC Membership Activation Date Dynamic Tag for Elementor
 */
 ...
 */
class MMCMembershipActivationDateTag extends \Elementor\Core\DynamicTags\Tag {
    /**
     * Get tag name
     *
     * @return string
    ...
    public function get_title() {
        return esc_html__('MMC Membership Activation Date', 'mmc-membership');
    }
