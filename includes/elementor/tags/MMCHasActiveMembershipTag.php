<?php
/**
 * MMC Has Active Membership Dynamic Tag for Elementor
 */
 ...
 */
class MMCHasActiveMembershipTag extends \Elementor\Core\DynamicTags\Tag {
    /**
     * Get tag name
     *
     * @return string
    ...
    public function get_title() {
        return esc_html__('MMC Has Active Membership', 'mmc-membership');
    }
